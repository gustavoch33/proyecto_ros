...
(cl:in-package zlac706_driver_control-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <wheel_status>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'wheel_status)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name zlac706_driver_control-msg:<wheel_status> is deprecated: use zlac706_driver_control-msg:wheel_status instead.")))

(cl:ensure-generic-function 'status-val :lambda-list '(m))
(cl:defmethod status-val ((m <wheel_status>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader zlac706_driver_control-msg:status-val is deprecated.  Use zlac706_driver_control-msg:status instead.")
  (status m))

(cl:ensure-generic-function 'voltage-val :lambda-list '(m))
(cl:defmethod voltage-val ((m <wheel_status>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader zlac706_driver_control-msg:voltage-val is deprecated.  Use zlac706_driver_control-msg:voltage instead.")
  (voltage m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<wheel_status>)))
  ...
  "zlac706_driver_control/wheel_status")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'wheel_status)))
  "Returns string type for a message object of type 'wheel_status"
  "zlac706_driver_control/wheel_status")
