...
set(MSG_I_FLAGS "-Icontroller:/home/odroid/catkin_ws/src/controller/msg;-Igeometry_msgs:/opt/ros/noetic/share/geometry_msgs/cmake/../msg;-Istd_msgs:/opt/ros/noetic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/odroid/catkin_ws/src/controller/msg/DatosControl.msg" NAME_WE)
add_custom_target(_controller_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "controller" "/home/odroid/catkin_ws/src/controller/msg/DatosControl.msg" ""
)

get_filename_component(_filename "/home/odroid/catkin_ws/src/controller/msg/Trayectoria.msg" NAME_WE)
add_custom_target(_controller_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "controller" "/home/odroid/catkin_ws/src/controller/msg/Trayectoria.msg" ""
)
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/controller)
  install(CODE "execute_process(COMMAND \"/usr/bin/python3\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/controller\")")
  # install generated code
  install(
