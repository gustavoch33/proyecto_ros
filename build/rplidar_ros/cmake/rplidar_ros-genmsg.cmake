...
get_filename_component(_filename "/home/odroid/catkin_ws/src/rplidar_ros/srv/motor_speed.srv" NAME_WE)
add_custom_target(_rplidar_ros_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "rplidar_ros" "/home/odroid/catkin_ws/src/rplidar_ros/srv/motor_speed.srv" ""
)
...
_generate_srv_cpp(rplidar_ros
  "/home/odroid/catkin_ws/src/rplidar_ros/srv/motor_speed.srv"
  "${MSG_I_FLAGS}"
  ""
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/rplidar_ros)
  install(CODE "execute_process(COMMAND \"/usr/bin/python3\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/rplidar_ros\")")
  # install generated code
  install(
